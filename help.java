/* SkillsServer.java
 *
 * Created on December 10, 2006, 2:53 PM
 *
...
public class SkillsServer
{
  ...
  static final String dbURL = "jdbc:mysql://localhost/j2mebook?" + "user=root&password=Hassan";
  ...
  public void acceptConnections()
  {
    ...
    //Entering the infinite loop\cf0\f0\par
    while (true)
    {
      try
      {
  ...
  class ServerThread implements Runnable
  {
    ...
    {
      //Inside the constructor: store the passed object in the data member\cf2  \par
      this.socket = socket;
    }
    //This is where you place the code you want to run in a thread\par
    //Every instance of a ServerThread will handle one client (TCP connection)\cf2\par
    public void run()
    {
      try
      {
    ...
    private String getNames(String skill)
    {
      ...
      try
      {
        ...
        String query = "SELECT lastname, firstname " + "FROM skills " + "WHERE skill = " + "'" + skill.trim() + "'" +" ORDER BY lastname";
